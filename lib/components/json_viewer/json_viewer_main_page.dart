    ...
    return Row(
      children: [
        Container(
          color: Colors.white,
          height: size.height,
          width: size.width * JsonViewMainPageRate.left,
        ...
        MouseRegion(
          ...
          child: GestureDetector(
            ...
            onPanUpdate: (details){
              setState(() {
                JsonViewMainPageRate.setByXDelta(size.width, details.delta.dx);
              });
        ...
        Expanded(child: Container(color: Colors.green,height: size.height,width: size.width * JsonViewMainPageRate.right,child: JsonViewerRightPage(key: jsonViewerRightGlobalKey,),))
      ],
    );
  }
}